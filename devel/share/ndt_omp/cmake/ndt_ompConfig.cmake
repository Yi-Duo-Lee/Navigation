...
if("TRUE" STREQUAL "TRUE")
  set(ndt_omp_SOURCE_PREFIX /home/robot/Navigation/src/ndt_omp_1)
  set(ndt_omp_DEVEL_PREFIX /home/robot/Navigation/devel)
  set(ndt_omp_INSTALL_PREFIX "")
  set(ndt_omp_PREFIX ${ndt_omp_DEVEL_PREFIX})
else()
  set(ndt_omp_SOURCE_PREFIX "")
  set(ndt_omp_DEVEL_PREFIX "")
  set(ndt_omp_INSTALL_PREFIX /home/robot/Navigation/install)
...
if(NOT "/home/robot/Navigation/src/ndt_omp_1/include " STREQUAL " ")
  set(ndt_omp_INCLUDE_DIRS "")
  set(_include_dirs "/home/robot/Navigation/src/ndt_omp_1/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ndt_omp' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/robot/Navigation/src/ndt_omp_1/${idir}'.  ${_report}")
    endif()
